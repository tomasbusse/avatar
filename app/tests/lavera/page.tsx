      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-green-100 text-green-800">
            ...
            <span className="text-sm font-medium">Lavera Natural Cosmetics</span>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <p className="mt-4 text-xs text-gray-500 text-center">
            Your results will be sent to your email address and to the Lavera HR team.
          </p>
        </div>
      </div>
    </div>
...
function QuestionSlide({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-green-50/20 to-amber-50/10">
      {/* Header */}
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-gray-900">Lavera Placement Test</span>
            </div>
...
function ResultsScreen({
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-white via-green-50/30 to-amber-50/20">
        ...
        >
          ...
          <div className="bg-white rounded-xl p-6 text-center border border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">
              The Lavera HR team has also been notified of your results.
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 text-gray-400">
              ...
              <span className="text-sm">Powered by Lavera Natural Cosmetics</span>
            </div>
          </div>
        </div>
      </div>
...
export default function LaveraPlacementTestPage() {
    ...
    case "results":
      ...
      return (
        <ResultsScreen
          userInfo={userInfo}
          results={results}
          levelDescription={laveraPlacementTest.levelDescriptions[results.level]}
        />
      );
  }
}
...
async function sendResultsEmail(
  ...
  const response = await fetch("/api/tests/lavera/send-results", {
    method: "POST",
