...
import { Breadcrumbs, ContactForm, ContactInfo, FAQAccordion } from "@/components/landing";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://simmonds.online/${locale}/contact`,
      languages: {
        de: "https://simmonds.online/de/contact",
        en: "https://simmonds.online/en/contact",
      },
    },
    openGraph: {
      title: `${t("headline")} | Simmonds Language Services`,
      description: t("subheadline"),
      url: `https://simmonds.online/${locale}/contact`,
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            {/* Contact Info - now fetched from Convex siteConfig */}
            <ContactInfo />
          </div>
        </div>
      </section>
